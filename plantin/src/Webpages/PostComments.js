...
export default function PostComments({ id }) {
  ...
  const commentsfetch = async () => {
    try {
      const response = await axios.get(
        `https://plantinapp.me/post/comments/fetch/${id}`
      );
  ...
  const repliesfetch = async () => {
    try {
      const response = await axios.get(
        `https://plantinapp.me/post/comments/replays/fetch/${id}`
      );
  ...
  const commentDelete = async (id, postid) => {
    try {
      const response = await axios.post(
        "https://plantinapp.me/post/comments/delete",
        {
          id,
          postid,
        }
  ...
  const repliesDelete = async (id, commentid) => {
    try {
      const response = await axios.post(
        "https://plantinapp.me/post/comments/replays/delete",
        {
          id,
          commentid,
        }
    ...
    <div className="comments">
      <Formik
        ...
        onSubmit={(data, { resetForm }) => {
          axios
            .post("https://plantinapp.me/post/comments", {
              postid: id,
              userid: userid.id,
              username,
              ...
              <div>
                <Formik
                  ...
                  onSubmit={async (replay, { resetForm }) => {
                    const response = await axios.post(
                      "https://plantinapp.me/post/comments/replays",
                      {
                        postid: data.postid,
                        commentid: data._id,
                        userid: userid.id,
